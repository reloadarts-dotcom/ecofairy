    ...
    <footer className="bg-sand-100 border-t border-sand-200">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          <div className="col-span-1 md:col-span-5">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-3xl font-serif font-light text-sand-900">
                EcoFairy
              </h3>
            </div>
        ...
        <div className="mt-16 pt-8 border-t border-sand-200 text-center">
          <p className="text-sm text-sand-500">&copy; {new Date().getFullYear()} EcoFairy Cleaning. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
